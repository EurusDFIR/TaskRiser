        ...
        <nav className="bg-[#e0f7fa]/70 backdrop-blur-lg border-b border-[#90e0ef]/60 shadow-md">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-16">
                    <Link href="/" className="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#00b4d8] via-[#48cae4] to-[#0077b6] hover:from-[#48cae4] hover:to-[#90e0ef]">
                        TaskRiser
                    </Link>
